function [currVer, installType] = checkRaven(developMode, checkBinaries)
% checkRaven
...
%
% Usage: [currVer, installType] = checkRaven(developMode)
...
%Get the RAVEN path. checkRaven.m sits in the RAVEN root.
...
try
    ...
    try
        ...
        printOrange('Fail\n')
        fprintf(['   You might have to rerun checkRaven again\n'...

...
% -------
% Z : double
%     a vector with Z-scores that tells you for each reaction how likely it
%     is for its flux to have increased (positive sign) or decreased
%     (negative sign) in the second condition with respect to the first.
%
% Examples
% --------

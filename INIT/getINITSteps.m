...
%                 '4-step' - 4-step run - similar to default but the last 
%                          step is split in two. Sometimes faster.
%                 (opt, default 'default')
%
...
elseif strcmp(series,'structural') %Skips step 3
    params1 = struct();
    params1.MIPGap = 0.0004;
    params1.TimeLimit = 120;
    params2 = struct();
...
elseif strcmp(series,'4-step') %the last step is split into two steps
    params1 = struct();
    params1.MIPGap = 0.0004;
    params1.TimeLimit = 120;
    params2 = struct();
    ...
    steps = { ...
        INITStepDesc(true, true, 'ignore', [1,1,1,1,1,1,1,0], metsToIgnore, params, {10;20}); ...
        INITStepDesc(false, false, 'exclude', [1,1,1,1,1,1,1,0], metsToIgnore, params, {10;20}); ...
        INITStepDesc(false, false, 'essential', [1,1,0,0,1,0,0,0], metsToIgnore, params, {10;20}); ...
        INITStepDesc(false, false, 'essential', [1,0,0,0,1,0,0,0], metsToIgnore, params, {10;20}); ...
        };
else

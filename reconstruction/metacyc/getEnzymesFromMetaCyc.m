...
% getEnzymesFromMetaCyc  Retrieve enzymes and reaction-enzyme associations.
%
% Retrieves all enzymes and reaction-enzyme association information in
% MetaCyc.
%
% Parameters
% ----------
% metacycPath : char, optional
%     if metaCycEnzymes.mat is not in the RAVEN\external\metacyc directory,
%     this function will attempt to build it by reading info from a local
%     dump of MetaCyc database, and metacycPath is the path to the MetaCyc
%     data files.
%
% Returns
% -------
% metaCycEnzymes : struct
...
%       specific enzyme to the reactions it catalyzes
...
%
% This is how one entry looks in the files:

...
% getMetsFromMetaCyc  Retrieve all metabolites from the MetaCyc database.
%
% If the file metaCycMets.mat is in the RAVEN\external\metacyc directory it
% will be directly loaded. Otherwise, it will be generated by parsing the
% MetaCyc database files. In general, this metaCycMets.mat file should be
% removed and rebuilt when a newer version of MetaCyc is released.
%
% Parameters
% ----------
% metacycPath : char
%     if metacycMets.mat is not in the RAVEN\external\metacyc directory,
%     this function will attempt to build it by reading info from a local
%     dump of the MetaCyc database, and metacycPath is the path to the
%     MetaCyc data files.
%
% Returns
% -------
...
%     - metNames : compound name (reuses the compound id if no name is provided)
...
%     - metMiriams : if a CHEBI id is available, it is saved here

...
% combineMetaCycKEGGModels  Combine MetaCyc and KEGG draft models into one.
%
% Parameters
% ----------
% metacycModel : struct
%     the reconstructed model from MetaCyc.
% keggModel : struct
%     the reconstructed model from KEGG.
%
% Returns
% -------
% model : struct
%     a model structure generated by integrating information from draft
%     models reconstructed using MetaCyc and KEGG databases. The
%     'rxnFrom/metFrom/geneFrom' fields are included to indicate the
%     source.
%
% Examples
% --------

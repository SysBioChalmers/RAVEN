...
% markPathwayWithExpression  Add gene expression data to a pathway object.
%
% Parameters
% ----------
% pathway : struct
...
%     a model structure.
% experiment : struct
%     experiment structure as generated by getExpressionStructure.
% experimentOrder : cell
%     cell array with two experiment names as defined in 'experiment'.
%
% Returns
% -------
% pathway : struct
%     updated pathway object.
%
% Examples
% --------
%     pathway = markPathwayWithExpression(pathway, model, experiment, ...
%         experimentOrder);

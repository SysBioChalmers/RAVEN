...
% trimPathway  Delete reactions from a pathway object.
%
% Parameters
% ----------
% pathway : struct
...
% rxnsToKeep : cell
%     cell array with the IDs of the reactions to keep.
% deleteUnconnectedMets : logical, optional
%     delete metabolites that are no longer connected by any reactions
%     (default true).
%
% Returns
% -------
% pathway : struct
%     an updated pathway object.
%
% Examples
% --------
%     pathway = trimPathway(pathway, rxnsToKeep, deleteUnconnectedMets);
